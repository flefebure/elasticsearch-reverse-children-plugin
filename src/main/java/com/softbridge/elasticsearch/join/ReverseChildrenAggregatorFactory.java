...
public class ReverseChildrenAggregatorFactory
        extends ValuesSourceAggregatorFactory<WithOrdinals, ReverseChildrenAggregatorFactory> {

    private final Query parentFilter;
    private final Query childFilter;

    public ReverseChildrenAggregatorFactory(String name, ValuesSourceConfig<WithOrdinals> config,
    ...
    protected Aggregator createUnmapped(Aggregator parent, List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData)
        ...
        return new NonCollectingAggregator(name, context, parent, pipelineAggregators, metaData) {
            ...
            public InternalAggregation buildEmptyAggregation() {
                return new InternalReverseChildren(name, 0, buildEmptySubAggregations(), pipelineAggregators(), metaData());
            }
    ...
    protected Aggregator doCreateInternal(WithOrdinals valuesSource, Aggregator parent,
        ...
        return new ReverseChildrenToParentAggregator(name, factories, context, parent, childFilter,
